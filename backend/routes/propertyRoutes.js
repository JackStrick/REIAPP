...
const { getUserProperties, getProperties, getPropertyById, getPropertyAnalytics, isUserProperty, addUserProperty, removeUserProperty } = require('../controllers/propertyController')
