...
function SellLeaseOptionForm({ formData }) {
	...
	const getBackEnd = () => {
		...
		const optionPayment =
			(parseFloat(formData.optionPayment) || 0) -
			(parseFloat(sellerFormState.optionPayment) || 0);
		const credits =
			(parseFloat(formData.monthlyCredit) || 0) -
			(parseFloat(sellerFormState.monthlyCredits) || 0);
	...
	const getNetProfit = () => {
		const totalCashFlow =
			(sellerFormState.monthlyRental - formData.monthlyRental) *
			sellerFormState.optionTerm;
		const creditsDifference =
			(formData.monthlyCredit - sellerFormState.monthlyCredits) *
			sellerFormState.optionTerm;
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(formData.salesPrice)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(formData.optionPayment)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(formData.monthlyRental)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					<Grid item xs={6} position="end">
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							In - Monthly Credits From Seller
						</Typography>
					</Grid>
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(formData.monthlyCredit)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
			...
			<FormControl fullWidth sx={{ marginTop: 0, marginBottom: 0 }}>
				<Grid container>
					...
					<Grid item xs={6}>
						...
						>
							{formatDollarValue(
								sellerFormState.optionPayment -
									formData.optionPayment
							)}
						</Typography>
					</Grid>
				</Grid>
