...
function SellerFinanceSellerFinance({ formData }) {
    ...
    const getLoanPayment = () => {
        ...
        const amortizationTerm = parseFloat(sellerFormState.amortizationTerm) || 0;
    ...
    return (
        ...
        {/* Subheading */}
        <Typography variant="h6" fontWeight="bold" sx={{ marginTop: 2, marginBottom: 1 }}>
            Loan With Seller
        </Typography>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Total Loan Amount</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue((parseFloat(formData.loanAmount) || 0) - (parseFloat(formData.downPayment) || 0))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Monthly P&I Payment</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue(parseFloat(formData.monthlyPayment) || 0)}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                ...
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue((parseFloat(formData.propertyInsurance) || 0) + (parseFloat(formData.propertyTax) || 0) + (parseFloat(formData.hoa) || 0 ))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Total Monthly Payment</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue((parseFloat(formData.monthlyPayment) || 0) + (parseFloat(formData.propertyInsurance) || 0) + (parseFloat(formData.propertyTax) + parseFloat(formData.hoa) || 0))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        ...
        <FormControl fullWidth sx={{ marginTop: 0, marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6} position="end">
                    <Typography position="end" variant="h6" align="left" sx={{ marginBottom: 2 }}>Sales Price</Typography>   
                </Grid>
                <Grid item xs={6}>    
                    <Typography position="end" variant="h6" align="right" sx={{ marginBottom: 2 }}>{formatDollarValue(sellerFormState.estPurchPrice)}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Loan Amount</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue(parseFloat(sellerFormState.loanAmount) - parseFloat(sellerFormState.downPayment))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                ...
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue(parseFloat(sellerFormState.monthlyPayment))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                ...
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue((parseFloat(sellerFormState.propertyInsurance) + parseFloat(sellerFormState.propertyTax) + parseFloat(sellerFormState.hoa)))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                ...
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue((parseFloat(sellerFormState.monthlyPayment) + parseFloat(sellerFormState.propertyInsurance) + parseFloat(sellerFormState.propertyTax) + parseFloat(sellerFormState.hoa)))}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        ...
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Total Received</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue(getReceived())}</Typography>
                </Grid>
            </Grid>
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 0 }}>
            <Grid container >
                <Grid item xs={6}>
                    <Typography className="analysis-typography" align="left" variant="h6" sx={{ marginBottom: 2 }}>Total Expenses</Typography>
                </Grid>
                <Grid item xs={6}>    
                    <Typography className="analysis-typography" align="right" variant="h6" sx={{ marginBottom: 2 }}>{formatDollarValue(getTotalExpense())}</Typography>
                </Grid>
            </Grid>
        </FormControl>
