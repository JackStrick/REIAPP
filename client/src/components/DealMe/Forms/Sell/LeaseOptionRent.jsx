...
function LeaseOptionRent({ formData }) {
	...
	const netOpIncome = () => {
		...
		return (
			numMonthlyOperating -
			(numMonthlyOperating * (numPercentVacant / 100) + numMonthlyOpCost)
		);
	};
	...
	const getCashOnCash = () => {
		...
		const profit =
			(netOpIncome() - parseFloat(formData.monthlyRental)) * 12;
			...
			<FormControl fullWidth sx={{ marginBottom: 0 }}>
				<Grid container>
					...
					<Grid item xs={6}>
						...
						>
							{formatDollarValue(
								netOpIncome() - formData.monthlyRental
							)}
						</Typography>
					</Grid>
				</Grid>
			...
			<FormControl fullWidth sx={{ marginBottom: 0 }}>
				<Grid container>
					...
					<Grid item xs={6}>
						...
						>
							{formatDollarValue(
								(netOpIncome() - formData.monthlyRental) * 12
							)}
						</Typography>
					</Grid>
				</Grid>
