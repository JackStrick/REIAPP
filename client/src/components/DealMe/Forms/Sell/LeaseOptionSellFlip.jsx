...
function LeaseOptionSellFlip({ formData }) {
	...
	const getMonthlyCost = () => {
		const numMonthlyHoldingCost =
			parseFloat(sellerFormState.monthlyHoldingCost) || 0;
	...
	const getOutOfPocketCost = () => {
		...
		return (
			optionPayment +
			rentalPayment * monthsToSell +
			marketing +
			holdingCost * monthsToSell +
			repairCost
		);
	};
			...
			<FormControl fullWidth sx={{ marginBottom: 0 }}>
				<Grid container>
					...
					<Grid item xs={6}>
						...
						>
							{formatDollarValue(
								sellerFormState.estimatedRepairCost
							)}
						</Typography>
					</Grid>
				</Grid>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getMonthlyCost())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(sellerFormState.marketingCost)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(sellerFormState.sellingCost)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getOutOfPocketCost())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(sellerFormState.askingPrice)}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getAllInCost())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
