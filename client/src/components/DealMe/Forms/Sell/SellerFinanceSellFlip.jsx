			...
			<FormControl fullWidth sx={{ marginBottom: 0 }}>
				<Grid container>
					...
					<Grid item xs={6}>
						...
						>
							{formatDollarValue(
								formData.loanAmount - formData.downPayment
							)}
						</Typography>
					</Grid>
				</Grid>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getCashRequired())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					...
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getLoanPayments())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
				...
				<Grid container>
					<Grid item xs={6} position="end">
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							Balance after {getHoldingTime()} months
						</Typography>
					</Grid>
					<Grid item xs={6}>
						<Typography
							...
							sx={{ marginBottom: 2 }}
						>
							{formatDollarValue(getLoanBalance())}
						</Typography>
					</Grid>
				</Grid>
			</FormControl>
